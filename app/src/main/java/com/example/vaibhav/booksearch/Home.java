...
public class Home extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        bookTypes.add("love");
        bookTypes.add("poetry");
        bookTypes.add("music");
        bookTypes.add("Humor");
        final BookHomehorizontalSlider bookHomehorizontalSlider = new BookHomehorizontalSlider(bookTypes, getContext());

        rvListBook.setAdapter(bookHomehorizontalSlider);
